...
void fill(uint8_t *buff,uint8_t x0,uint8_t y0,uint8_t x,uint8_t y,uint8_t color);

void clearcircle(uint8_t *buff,uint8_t x0, uint8_t y0, uint8_t r,uint8_t color);
void clear(uint8_t *buff,uint8_t x0,uint8_t y0,uint8_t x,uint8_t y,uint8_t color);

void drawbackground();
void drawpad(uint8_t *buff,uint8_t pad_c,uint8_t id);
void clearpad(uint8_t *buff,uint8_t pad_c,uint8_t id);

uint8_t movepad0(uint8_t *buff,uint8_t pad_c0,uint8_t x,uint8_t y);
uint8_t movepad1(uint8_t *buff,uint8_t pad_c1,uint8_t x,uint8_t y);
